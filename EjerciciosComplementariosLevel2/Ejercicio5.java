...
public class Ejercicio5 {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> horasTrabajadas = new ArrayList<>(List.of(6, 7, 8, 4, 5));
        List<Integer> valorXHora = new ArrayList<>(List.of(350, 345, 550, 600, 320));

        calcularMontoTotal(horasTrabajadas, valorXHora);
    }

    public static void calcularMontoTotal(List<Integer> horas, List<Integer> valor) {
